...
def filter_by_currency(transactions: list[dict], currency: str) -> Iterator[Dict]:
    ...
    if isinstance(transactions, list) and len(transactions) > 0:
        for transaction in transactions:
            if transaction.get("operationAmount", {}).get("currency", {}).get("code") == currency and isinstance(transaction, dict):
               yield transaction
            else:
...
if __name__ == '__main__':
    filter_by_currency([{"id": 939719570,
        "state": "EXECUTED",
...
usd_transaction = filter_by_currency([{"id": 939719570,
        "state": "EXECUTED",
        "date": "2018-06-30T02:08:58.425572",
        "operationAmount": {
            "amount": "9824.07",
...
descriptions = transaction_descriptions([{"id": 939719570,
        "state": "EXECUTED",
        "date": "2018-06-30T02:08:58.425572",
        "operationAmount": {
            "amount": "9824.07",
...
if __name__ == '__main__':
    transaction_descriptions([{"id": 939719570,
        "state": "EXECUTED",
        "date": "2018-06-30T02:08:58.425572",
        "operationAmount": {
            "amount": "9824.07",
...
XXXX XXXX XXXX XXXX, где X— цифра номера карты"""
    if isinstance(start, int) and isinstance(stop, int) and stop > 0:
